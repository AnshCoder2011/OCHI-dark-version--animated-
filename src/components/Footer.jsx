...
function Footer() {
  return (
    <div
      ...
      data-scroll-section
      data-scroll-speed=".3"
      className="w-full h-[120vh] font-primaryregular flex p-16 pt-20"
    >
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="font-primarysemi text-9xl leading-none -mb-6">EYE-</h1>
          <h1 className="uppercase font-primarysemi text-9xl leading-none -mb-6">
            opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="uppercase font-primarysemi text-9xl">presentations</h1>
        <br />
        <div className="w-1/2">
          <h1>S:</h1>
          <br />
          <div className="flex flex-col w-16 leading-relaxed">
            <a
              className="relative after:bg-white after:absolute after:h-[1.5px] after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300 cursor-pointer"
              href="#"
            >
              Instagram
            </a>
          ...
          <div className="flex flex-col">
            <a className="underline underline-offset-4 cursor-pointer" href="#">
              202-1965 W 4th Ave
            </a>
            <a className="underline underline-offset-4 cursor-pointer" href="#">
              Vancouver, Canada
