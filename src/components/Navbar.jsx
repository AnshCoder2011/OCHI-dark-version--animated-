...
function Navbar() {
  return (
    <div className="fixed z-[999] w-full px-16 py-6 font-primaryregular flex justify-between items-center">
      <div className="logo">
        <svg
          width="72"
          height="30"
      ...
      <div className="links flex gap-10">
        {["Services", "Our Work", "About us", "Insights", "Contact us"].map(
          (item, index) => (
            <a
              key={index}
              className={`text-md capitalize font-light relative after:bg-white after:absolute after:h-[1.3px] after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-500 cursor-pointer ${
                index === 4 && "ml-56"
              }`}
              href="#"
            >
