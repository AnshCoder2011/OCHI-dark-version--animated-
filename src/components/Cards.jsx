...
function Cards() {
  return (
    <div
      ...
      className="h-screen w-full bg-zinc-100 flex items-center px-20 gap-5 font-primaryregular"
    >
      <div className="cardcontainer h-96 w-1/2">
        <div className="card relative rounded-xl w-full h-full flex items-center justify-center bg-[#004D43]">
          ...
          <button className="absolute left-10 bottom-10 px-5 py-1 border-2 rounded-full border-[#94BF5E] text-[#94BF5E] font-bold">
            &copy;2019-2022
          </button>
        </div>
      </div>
      <div className="cardcontainer h-96 w-1/2 flex gap-5">
        <div className="card relative rounded-xl w-1/2 h-full bg-[#212121] flex items-center justify-center">
          ...
          <button className="absolute left-10 bottom-10 px-5 py-1 border-[1px] rounded-full border-[#fff] text-[#fff]">
        ...
        <div className="card relative rounded-xl w-1/2 h-full bg-[#212121] flex items-center justify-center">
          <img
            ...
            className="scale-50"
          />
          <button className="absolute left-[6%] bottom-10 px-5 py-1 border-[1px] rounded-full border-[#fff] text-[#fff]">
